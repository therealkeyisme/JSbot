...
exports.adminHelpStatement = exports.helpStatement = void 0;
const helpStatement = (switchValue) => {
    let embedMessage;
    let embedTitle;
    switch (switchValue) {
        case 'request':
...
exports.helpStatement = helpStatement;
const adminHelpStatement = (switchValue) => {
    let embedMessage;
    let embedTitle;
    switch (switchValue) {
        case 'embed':
...
exports.adminHelpStatement = adminHelpStatement;
