...
import {
  ...
  findDate,
  dbAnalysis,
} from '../../../utils/commands/eventfn';
import { DB } from '../../../database/database';
import { regExpObj } from '../../../utils/regExpObj';
...
module.exports = {
  run: async (client: any, message: any) => {
    ...
    const defaultFilter = (m: any) => m.content.startsWith('');
    const timeDateFiler = (m: any) => {
    ...
    try {
      ...
      let event: any = findDate(startTime);
